PokemonTower5F_Script:
	...
	ld hl, PokemonTower5FTrainerHeaders
...
PokemonTower5FDefaultScript:
	; Check if player is in purified zone
	ld hl, PokemonTower5FPurifiedZoneCoords
	call ArePlayerCoordsInArray
	jr c, .in_purified_zone

	; Not sure why it sets bit here
	ld hl, wStatusFlags4
	res BIT_NO_BATTLES, [hl]
	ResetEvent EVENT_POKEMONTOWER_IN_PURIFIED_ZONE
	jp CheckFightingMapTrainers

.in_purified_zone
	; Check and set
	CheckAndSetEvent EVENT_POKEMONTOWER_IN_PURIFIED_ZONE
	ret nz
...
PokemonTower5FTrainerHeaders:
	def_trainers 2
PokemonTower5FTrainerHeader0:
	trainer EVENT_POKEMONTOWER_5F_BEAT_TRAINER_0, 2, PokemonTower5FChanneler2BattleText, PokemonTower5FChanneler2EndBattleText, PokemonTower5FChanneler2AfterBattleText
PokemonTower5FTrainerHeader1:
	trainer EVENT_POKEMONTOWER_5F_BEAT_TRAINER_1, 3, PokemonTower5FChanneler3BattleText, PokemonTower5FChanneler3EndBattleText, PokemonTower5FChanneler3AfterBattleText
PokemonTower5FTrainerHeader2:
	trainer EVENT_POKEMONTOWER_5F_BEAT_TRAINER_2, 2, PokemonTower5FChanneler4BattleText, PokemonTower5FChanneler4EndBattleText, PokemonTower5FChanneler4AfterBattleText
PokemonTower5FTrainerHeader3:
	trainer EVENT_POKEMONTOWER_5F_BEAT_TRAINER_3, 2, PokemonTower5FChanneler5BattleText, PokemonTower5FChanneler5EndBattleText, PokemonTower5FChanneler5AfterBattleText
	db -1 ; end
