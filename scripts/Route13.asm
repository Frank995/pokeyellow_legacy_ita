...
Route13TrainerHeader0:
	trainer EVENT_ROUTE_13_BEAT_TRAINER_0, 2, Route13CooltrainerM1BattleText, Route13CooltrainerM1EndBattleText, Route13CooltrainerM1AfterBattleText
Route13TrainerHeader1:
	trainer EVENT_ROUTE_13_BEAT_TRAINER_1, 2, Route13CooltrainerF1BattleText, Route13CooltrainerF1EndBattleText, Route13CooltrainerF1AfterBattleText
Route13TrainerHeader2:
	trainer EVENT_ROUTE_13_BEAT_TRAINER_2, 2, Route13CooltrainerF2BattleText, Route13CooltrainerF2EndBattleText, Route13CooltrainerF2AfterBattleText
Route13TrainerHeader3:
	trainer EVENT_ROUTE_13_BEAT_TRAINER_3, 2, Route13CooltrainerF3BattleText, Route13CooltrainerF3EndBattleText, Route13CooltrainerF3AfterBattleText
Route13TrainerHeader4:
	trainer EVENT_ROUTE_13_BEAT_TRAINER_4, 4, Route13CooltrainerF4BattleText, Route13CooltrainerF4EndBattleText, Route13CooltrainerF4AfterBattleText
Route13TrainerHeader5:
	trainer EVENT_ROUTE_13_BEAT_TRAINER_5, 2, Route13CooltrainerM2BattleText, Route13CooltrainerM2EndBattleText, Route13CooltrainerM2AfterBattleText
Route13TrainerHeader6:
	trainer EVENT_ROUTE_13_BEAT_TRAINER_6, 4, Route13Beauty1BattleText, Route13Beauty1EndBattleText, Route13Beauty1AfterBattleText
Route13TrainerHeader7:
	trainer EVENT_ROUTE_13_BEAT_TRAINER_7, 2, Route13Beauty2BattleText, Route13Beauty2EndBattleText, Route13Beauty2AfterBattleText
Route13TrainerHeader8:
	trainer EVENT_ROUTE_13_BEAT_TRAINER_8, 2, Route13BikerBattleText, Route13BikerEndBattleText, Route13BikerAfterBattleText
Route13TrainerHeader9:
	trainer EVENT_ROUTE_13_BEAT_TRAINER_9, 4, Route13CooltrainerM3BattleText, Route13CooltrainerM3EndBattleText, Route13CooltrainerM3AfterBattleText
	db -1 ; end
