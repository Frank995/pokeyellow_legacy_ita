...
Route15TrainerHeader0:
	trainer EVENT_ROUTE_15_BEAT_TRAINER_0, 2, Route15CooltrainerF1BattleText, Route15CooltrainerF1EndBattleText, Route15CooltrainerF1AfterBattleText
Route15TrainerHeader1:
	trainer EVENT_ROUTE_15_BEAT_TRAINER_1, 3, Route15CooltrainerF2BattleText, Route15CooltrainerF2EndBattleText, Route15CooltrainerF2AfterBattleText
Route15TrainerHeader2:
	trainer EVENT_ROUTE_15_BEAT_TRAINER_2, 3, Route15CooltrainerM1BattleText, Route15CooltrainerM1EndBattleText, Route15CooltrainerM1AfterBattleText
Route15TrainerHeader3:
	trainer EVENT_ROUTE_15_BEAT_TRAINER_3, 3, Route15CooltrainerM2BattleText, Route15CooltrainerM2EndBattleText, Route15CooltrainerM2AfterBattleText
Route15TrainerHeader4:
	trainer EVENT_ROUTE_15_BEAT_TRAINER_4, 2, Route15Beauty1BattleText, Route15Beauty1EndBattleText, Route15Beauty1AfterBattleText
Route15TrainerHeader5:
	trainer EVENT_ROUTE_15_BEAT_TRAINER_5, 3, Route15Beauty2BattleText, Route15Beauty2EndBattleText, Route15Beauty2AfterBattleText
Route15TrainerHeader6:
	trainer EVENT_ROUTE_15_BEAT_TRAINER_6, 3, Route15Biker1BattleText, Route15Biker1EndBattleText, Route15Biker1AfterBattleText
Route15TrainerHeader7:
	trainer EVENT_ROUTE_15_BEAT_TRAINER_7, 3, Route15Biker2BattleText, Route15Biker2EndBattleText, Route15Biker2AfterBattleText
Route15TrainerHeader8:
	trainer EVENT_ROUTE_15_BEAT_TRAINER_8, 3, Route15CooltrainerF3BattleText, Route15CooltrainerF3EndBattleText, Route15CooltrainerF3AfterBattleText
Route15TrainerHeader9:
	trainer EVENT_ROUTE_15_BEAT_TRAINER_9, 3, Route15CooltrainerF4BattleText, Route15CooltrainerF4EndBattleText, Route15CooltrainerF4AfterBattleText
	db -1 ; end
