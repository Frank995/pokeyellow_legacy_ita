...
Route14TrainerHeader0:
	trainer EVENT_ROUTE_14_BEAT_TRAINER_0, 2, Route14CooltrainerM1BattleText, Route14CooltrainerM1EndBattleText, Route14CooltrainerM1AfterBattleText
Route14TrainerHeader1:
	trainer EVENT_ROUTE_14_BEAT_TRAINER_1, 2, Route14CooltrainerM2BattleText, Route14CooltrainerM2EndBattleText, Route14CooltrainerM2AfterBattleText
Route14TrainerHeader2:
	trainer EVENT_ROUTE_14_BEAT_TRAINER_2, 4, Route14CooltrainerM3BattleText, Route14CooltrainerM3EndBattleText, Route14CooltrainerM3AfterBattleText
Route14TrainerHeader3:
	trainer EVENT_ROUTE_14_BEAT_TRAINER_3, 3, Route14CooltrainerM4BattleText, Route14CooltrainerM4EndBattleText, Route14CooltrainerM4AfterBattleText
Route14TrainerHeader4:
	trainer EVENT_ROUTE_14_BEAT_TRAINER_4, 3, Route14CooltrainerM5BattleText, Route14CooltrainerM5EndBattleText, Route14CooltrainerM5AfterBattleText
Route14TrainerHeader5:
	trainer EVENT_ROUTE_14_BEAT_TRAINER_5, 4, Route14CooltrainerM6BattleText, Route14CooltrainerM6EndBattleText, Route14CooltrainerM6AfterBattleText
Route14TrainerHeader6:
	trainer EVENT_ROUTE_14_BEAT_TRAINER_6, 4, Route14Biker1BattleText, Route14Biker1EndBattleText, Route14Biker1AfterBattleText
Route14TrainerHeader7:
	trainer EVENT_ROUTE_14_BEAT_TRAINER_7, 4, Route14Biker2BattleText, Route14Biker2EndBattleText, Route14Biker2AfterBattleText
Route14TrainerHeader8:
	trainer EVENT_ROUTE_14_BEAT_TRAINER_8, 3, Route14Biker3BattleText, Route14Biker3EndBattleText, Route14Biker3AfterBattleText
Route14TrainerHeader9:
	trainer EVENT_ROUTE_14_BEAT_TRAINER_9, 4, Route14Biker4BattleText, Route14Biker4EndBattleText, Route14Biker4AfterBattleText
	db -1 ; end
