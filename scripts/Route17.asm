...
Route17TrainerHeader0:
	trainer EVENT_ROUTE_17_BEAT_TRAINER_0, 3, Route17Biker1BattleText, Route17Biker1EndBattleText, Route17Biker1AfterBattleText
Route17TrainerHeader1:
	trainer EVENT_ROUTE_17_BEAT_TRAINER_1, 4, Route17Biker2BattleText, Route17Biker2EndBattleText, Route17Biker2AfterBattleText
Route17TrainerHeader2:
	trainer EVENT_ROUTE_17_BEAT_TRAINER_2, 4, Route17Biker3BattleText, Route17Biker3EndBattleText, Route17Biker3AfterBattleText
Route17TrainerHeader3:
	trainer EVENT_ROUTE_17_BEAT_TRAINER_3, 4, Route17Biker4BattleText, Route17Biker4EndBattleText, Route17Biker4AfterBattleText
Route17TrainerHeader4:
	trainer EVENT_ROUTE_17_BEAT_TRAINER_4, 3, Route17Biker5BattleText, Route17Biker5EndBattleText, Route17Biker5AfterBattleText
Route17TrainerHeader5:
	trainer EVENT_ROUTE_17_BEAT_TRAINER_5, 2, Route17Biker6BattleText, Route17Biker6EndBattleText, Route17Biker6AfterBattleText
Route17TrainerHeader6:
	trainer EVENT_ROUTE_17_BEAT_TRAINER_6, 4, Route17Biker7BattleText, Route17Biker7EndBattleText, Route17Biker7AfterBattleText
Route17TrainerHeader7:
	trainer EVENT_ROUTE_17_BEAT_TRAINER_7, 2, Route17Biker8BattleText, Route17Biker8EndBattleText, Route17Biker8AfterBattleText
Route17TrainerHeader8:
	trainer EVENT_ROUTE_17_BEAT_TRAINER_8, 3, Route17Biker9BattleText, Route17Biker9EndBattleText, Route17Biker9AfterBattleText
Route17TrainerHeader9:
	trainer EVENT_ROUTE_17_BEAT_TRAINER_9, 4, Route17Biker10BattleText, Route17Biker10EndBattleText, Route17Biker10AfterBattleText
	db -1 ; end
