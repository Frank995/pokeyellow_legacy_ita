...
Route18TrainerHeader0:
	trainer EVENT_ROUTE_18_BEAT_TRAINER_0, 3, Route18CooltrainerM1BattleText, Route18CooltrainerM1EndBattleText, Route18CooltrainerM1AfterBattleText
Route18TrainerHeader1:
	trainer EVENT_ROUTE_18_BEAT_TRAINER_1, 3, Route18CooltrainerM2BattleText, Route18CooltrainerM2EndBattleText, Route18CooltrainerM2AfterBattleText
Route18TrainerHeader2:
	trainer EVENT_ROUTE_18_BEAT_TRAINER_2, 4, Route18CooltrainerM3BattleText, Route18CooltrainerM3EndBattleText, Route18CooltrainerM3AfterBattleText
	db -1 ; end
