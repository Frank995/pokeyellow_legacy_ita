...
INCLUDE "scripts/BluesHouse_2.asm"
...
INCLUDE "data/maps/headers/SSAnneBallroom.asm"
INCLUDE "scripts/SSAnneBallroom.asm"
INCLUDE "data/maps/objects/SSAnneBallroom.asm"
SSAnneBallroom_Blocks: INCBIN "maps/SSAnneBallroom.blk"
...
INCLUDE "scripts/PewterCity_2.asm"
