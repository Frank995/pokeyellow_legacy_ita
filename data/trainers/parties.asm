...
; Viridian Forest
	...
	db $FF, 6, WEEDLE, 7, METAPOD, 0
; Route 3
	db $FF, 8, METAPOD, 8, KAKUNA, 10, BUTTERFREE, 0
	db 9, KAKUNA, METAPOD, KAKUNA, METAPOD, 0
	db 9, METAPOD, PARAS, KAKUNA, 0
; Mt. Moon 1F
...
; Route 3
	db 9, ODDISH, ODDISH, 0
	db 10, NIDORAN_F, NIDORAN_M, 0
	db 14, JIGGLYPUFF, 0
; Mt. Moon 1F
	db 11, ODDISH, SANDSHREW, 0
	db 14, CLEFAIRY, 0
; Route 4
	db $FF, 12, FARFETCHD, 12, PSYDUCK, 13, NIDORAN_M, 13, NIDORAN_F, 0
; Route 24
...
; Victory Road 2F
	db 49, DROWZEE, HYPNO, KADABRA, ALAKAZAM, 0
; Fuchsia Gym
	db 34, BEEDRILL, NIDOKING, GOLBAT, HAUNTER, 0
	db 37, TENTACRUEL, MUK, 0
; Victory Road 2F
	db 53, ALAKAZAM, MR_MIME, 0
; Unused
	db 33, HYPNO, 0
; Fuchsia Gym
	db 40, HYPNO, 0
...
; Victory Road 2F
	db 52, PERSIAN, GOLDUCK, TANGELA, 0
; Unused
...
; Victory Road 2F
	db 52, POLIWRATH, MACHAMP, PINSIR, 0
...
GiovanniData:
; Rocket Hideout B4F
	db $FF, 29, NIDOKING, 31, KANGASKHAN, 30, ONIX, 32, PERSIAN, 0
; Silph Co. 11F
	db $FF, 44, KINGLER, 44, NIDOKING, 45, KANGASKHAN, 44, MACHAMP, 47, PERSIAN, 0
; Viridian Gym
	db $FF, 53, DUGTRIO, 55, PERSIAN, 54, NIDOKING, 55, RHYDON, 56, MACHAMP, 0
...
; Rematch
	db $FF, 71, HITMONCHAN, 70, POLIWRATH, 71, HITMONLEE, 72, ONIX, 73, MACHAMP, 0

BrockData:
	db $FF, 10, GEODUDE, 12, ONIX, 0
; Rematch
	db $FF, 64, KABUTOPS, 64, OMASTAR, 65, GOLEM, 66, ONIX, 0

MistyData:
	db $FF, 19, PSYDUCK, 18, GOLDEEN, 21, STARYU, 0
; Rematch
	db $FF, 64, SEADRA, 65, GOLDUCK, 65, SEAKING, 66, STARMIE, 0

LtSurgeData:
	db $FF, 29, RAICHU, 0
; Rematch
	db $FF, 64, ELECTRODE, 65, MAGNETON, 65, ELECTABUZZ, 66, RAICHU, 0

ErikaData:
	db $FF, 34, TANGELA, 37, WEEPINBELL, 36, GLOOM, 0
; Rematch
	db $FF, 64, PARASECT, 65, TANGELA, 66, VICTREEBEL, 65, VILEPLUME, 0

KogaData:
	db $FF, 43, GOLBAT, 43, MUK, 44, VENOMOTH, 0
; Rematch
	db $FF, 64, WEEZING, 66, GOLBAT, 65, MUK, 65, VENOMOTH, 0

SabrinaData:
	db $FF, 49, HYPNO, 50, HAUNTER, 51, KADABRA, 0
; Rematch
	db $FF, 64, SLOWBRO, 65, HYPNO, 65, GENGAR, 66, ALAKAZAM, 0

BlaineData:
	db $FF, 52, NINETALES, 53, RAPIDASH, 54, MAGMAR, 0
; Rematch
	db $FF, 64, ARCANINE, 65, NINETALES, 65, RAPIDASH, 66, MAGMAR, 0
...
; Rematch
	db $FF, 71, GENGAR, 70, GOLBAT, 71, MAROWAK, 72, ARBOK, 73, GENGAR, 0

LanceData:
	db $FF, 61, DRAGONITE, 60, GYARADOS, 60, CHARIZARD, 61, AERODACTYL, 62, DRAGONITE, 0
; Rematch
	db $FF, 71, DRAGONITE, 70, GYARADOS, 71, CHARIZARD, 72, AERODACTYL, 73, DRAGONITE, 0
