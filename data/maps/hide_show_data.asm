...
ViridianCityHS:
	db VIRIDIAN_CITY, VIRIDIANCITY_OLD_MAN_DRUNK, SHOW
	db VIRIDIAN_CITY, VIRIDIANCITY_OLD_MAN,       HIDE
CeruleanCityHS:
	db CERULEAN_CITY, CERULEANCITY_RIVAL,       SHOW
	db CERULEAN_CITY, CERULEANCITY_JENNY,       SHOW
...
Route2HS:
	db ROUTE_2, ROUTE2_CALCIUM, SHOW
	db ROUTE_2, ROUTE2_HP_UP,   SHOW
Route4HS:
	db ROUTE_4, ROUTE4_TM_RAZOR_WIND, SHOW
	db ROUTE_4, ROUTE4_SEYMOUR,       SHOW
	db ROUTE_4, ROUTE4_ZUBAT,         SHOW
Route9HS:
...
Route22HS:
	db ROUTE_22, ROUTE22_RIVAL, HIDE
Route24HS:
	db ROUTE_24, ROUTE24_ROCKET,  SHOW
...
CeruleanGymHS:
	db CERULEAN_GYM, CERULEANGYM_GYM_JESSIE, SHOW
	db CERULEAN_GYM, CERULEANGYM_GYM_JAMES, SHOW
CeruleanCaveHS:
...
BillsHouseHS:
	db BILLS_HOUSE, BILLSHOUSE_KABUTO, SHOW
	db BILLS_HOUSE, BILLSHOUSE_BILL,   HIDE
ViridianForestHS:
	...
	db VIRIDIAN_FOREST, VIRIDIANFOREST_JESSIE,    HIDE
	db VIRIDIAN_FOREST, VIRIDIANFOREST_JAMES,     HIDE
MtMoon1FHS:
...
SSAnne2FHS:
	db SS_ANNE_2F, SSANNE2F_RIVAL, SHOW
SSAnne3FHS:
	db SS_ANNE_3F, SSANNE3F_SAILOR1, SHOW
SSAnneBallroomHS:
	db SS_ANNE_BALLROOM, SSANNEBALLROOM_ROCKET1, HIDE
SSAnneCaptainsRoomHS:
	db SS_ANNE_CAPTAINS_ROOM, SSANNECAPTAINSROOM_JESSIE, HIDE
	db SS_ANNE_CAPTAINS_ROOM, SSANNECAPTAINSROOM_JAMES, HIDE
SSAnne1FRoomsHS:
...
MtMoonShrineHS:
	db MT_MOON_SHRINE, MTMOONSHRINE_JESSIE, SHOW
	db MT_MOON_SHRINE, MTMOONSHRINE_JAMES,  SHOW
VictoryRoad3FHS:
