...
PokemonTower7F_Object:
	...
	def_object_events
	object_event 10,  8, SPRITE_JESSIE, STAY, DOWN, TEXT_POKEMONTOWER7F_JESSIE, OPP_JESSIEJAMES, 7
	object_event 11,  8, SPRITE_JAMES, STAY, DOWN, TEXT_POKEMONTOWER7F_JAMES, OPP_JESSIEJAMES, 7
