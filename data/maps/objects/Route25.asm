...
Route25_Object:
	...
	def_warp_events
	warp_event 45,  9, BILLS_HOUSE, 1

	def_bg_events
	bg_event 46, 11, TEXT_ROUTE25_BILL_SIGN
	...
	object_event 18,  8, SPRITE_COOLTRAINER_F, STAY, RIGHT, TEXT_ROUTE25_COOLTRAINER_F1, OPP_LASS, 10
	object_event 32,  3, SPRITE_YOUNGSTER, STAY, LEFT, TEXT_ROUTE25_YOUNGSTER3, OPP_YOUNGSTER, 7
	object_event 37,  4, SPRITE_COOLTRAINER_F, STAY, DOWN, TEXT_ROUTE25_COOLTRAINER_F2, OPP_LASS, 11
