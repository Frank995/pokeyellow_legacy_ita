	...
	const_export SSANNE1FROOMS_ROCKET
...
SSAnne1FRooms_Object:
	...
	object_event 13, 11, SPRITE_COOLTRAINER_F, STAY, LEFT, TEXT_SSANNE1FROOMS_COOLTRAINER_F, OPP_LASS, 12
	object_event 20,  4, SPRITE_ROCKET, STAY, DOWN, TEXT_SSANNE1FROOMS_ROCKET
	...
	object_event 10, 13, SPRITE_GIRL, STAY, RIGHT, TEXT_SSANNE1FROOMS_GIRL
