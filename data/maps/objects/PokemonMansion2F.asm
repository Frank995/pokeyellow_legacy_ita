...
PokemonMansion2F_Object:
	...
	def_object_events
	object_event  3, 17, SPRITE_SUPER_NERD, WALK, LEFT_RIGHT, TEXT_POKEMONMANSION2F_SUPER_NERD, OPP_BURGLAR, 4
	object_event 17,  2, SPRITE_OAK, STAY, RIGHT, TEXT_POKEMONMANSION2F_OAK, OPP_PROF_OAK, 2
