...
ViridianForest_Object:
	...
	object_event 13, 17, SPRITE_YOUNGSTER, STAY, RIGHT, TEXT_VIRIDIANFOREST_YOUNGSTER4, OPP_BUG_CATCHER, 3
	object_event  2, 41, SPRITE_COOLTRAINER_F, STAY, NONE, TEXT_VIRIDIANFOREST_COOLTRAINER_F, OPP_LASS, 1
	object_event  2, 18, SPRITE_YOUNGSTER, STAY, LEFT, TEXT_VIRIDIANFOREST_SAMURAI, OPP_SAMURAI, 1
	...
	object_event  1,  7, SPRITE_JESSIE, STAY, UP, TEXT_VIRIDIANFOREST_JJ_JESSIE_BATTLE, OPP_JESSIEJAMES, 2
	object_event  2,  7, SPRITE_JAMES, STAY, UP, TEXT_VIRIDIANFOREST_JJ_JAMES_BATTLE, OPP_JESSIEJAMES, 2
