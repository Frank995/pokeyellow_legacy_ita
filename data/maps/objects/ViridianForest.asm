...
ViridianForest_Object:
	...
	object_event  1,  7, SPRITE_JESSIE, STAY, UP, TEXT_VIRIDIANFOREST_JESSIE, OPP_JESSIEJAMES, 2
	object_event  2,  7, SPRITE_JAMES, STAY, UP, TEXT_VIRIDIANFOREST_JAMES, OPP_JESSIEJAMES, 2
