...
ViridianForest_Object:
	...
	object_event  2, 18, SPRITE_YOUNGSTER, STAY, LEFT, TEXT_VIRIDIANFOREST_YOUNGSTER5, OPP_BUG_CATCHER, 4
	...
	object_event  1,  7, SPRITE_JESSIE, STAY, UP, TEXT_VIRIDIANFOREST_JJ_JESSIE_BATTLE, OPP_ROCKET, $2A
	object_event  2,  7, SPRITE_JAMES, STAY, UP, TEXT_VIRIDIANFOREST_JJ_JAMES_BATTLE, OPP_ROCKET, $2A
