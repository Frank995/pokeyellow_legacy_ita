...
MtMoonB2F_Object:
	...
	object_event  9,  3, SPRITE_JESSIE, STAY, LEFT, TEXT_MTMOONB2F_JESSIE, OPP_JESSIEJAMES, 3
	...
	object_event  9,  4, SPRITE_JAMES, STAY, LEFT, TEXT_MTMOONB2F_JAMES, OPP_JESSIEJAMES, 3
