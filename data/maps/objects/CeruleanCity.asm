	...
	const_export CERULEANCITY_JENNY
...
CeruleanCity_Object:
	...
	def_object_events
	object_event 20,  1, SPRITE_BLUE, STAY, DOWN, TEXT_CERULEANCITY_RIVAL, OPP_RIVAL1, 3
	...
	object_event 27, 12, SPRITE_OFFICER_JENNY, STAY, DOWN, TEXT_CERULEANCITY_JENNY
