...
SilphCo11F_Object:
	...
	object_event  2,  8, SPRITE_JAMES, STAY, UP, TEXT_SILPHCO11F_JAMES, OPP_JESSIEJAMES, 8
	object_event 15,  9, SPRITE_ROCKET, STAY, UP, TEXT_SILPHCO11F_ROCKET, OPP_ROCKET, 36
	object_event  3,  8, SPRITE_JESSIE, STAY, UP, TEXT_SILPHCO11F_JESSIE, OPP_JESSIEJAMES, 8
