...
; Route 25 events (very messy here)
	const_next $550 - 1
	const EVENT_ROUTE_24_GOT_CHARMANDER
	const EVENT_BILLS_HOUSE_MET_BILL
	...
	const_skip
	const EVENT_BILLS_HOUSE_USED_CELL_SEPARATOR
	const EVENT_BILLS_HOUSE_GOT_SS_TICKET
	const EVENT_BILLS_HOUSE_MET_BILL_2
	const EVENT_BILLS_HOUSE_SAID_USE_CELL_SEPARATOR
	const EVENT_ROUTE_25_LEFT_BILLS_HOUSE_AFTER_HELPING
...
; Mt. Moon events
	...
	const EVENT_MT_MOON_B2_GOT_DOME_FOSSIL
	const EVENT_MT_MOON_B2_BEAT_EXIT_SUPER_NERD
	const EVENT_MT_MOON_B2_BEAT_JJ
	const EVENT_MT_MOON_B2_BEAT_TRAINER_0
	const EVENT_MT_MOON_B2_BEAT_TRAINER_1
	const EVENT_MT_MOON_B2_BEAT_TRAINER_2
	const EVENT_MT_MOON_B2_TEMP
	const EVENT_MT_MOON_B2_GOT_HELIX_FOSSIL
